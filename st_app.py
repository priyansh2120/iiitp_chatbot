...
# constants
embeddings_fl, data_txt_fl = 'iiitp_embeddings.pkl', 'translated_data.json'
...
st.title("Edubot - College Q&A Chatbot")
st.caption("Find answers to any of your questions related to Indian Institute of Information Technology Pune")
